...
**ربات پست نمی‌زند:**
- از منوی اصلی (`/start`) وضعیت Auto-send را چک کنید — اگر 🔴 OFF است `/on` بزنید
- ربات وقتی خطای کانال می‌گیرد auto-send را خودکار خاموش می‌کند و یک پیام هشدار برای شما می‌فرستد
- از `/setchannel` مطمئن شوید کانال درست تنظیم شده
- مطمئن شوید ربات ادمین کانال است و دسترسی Post Messages دارد
- صف خالی؟ `/forcescrape` بزنید
